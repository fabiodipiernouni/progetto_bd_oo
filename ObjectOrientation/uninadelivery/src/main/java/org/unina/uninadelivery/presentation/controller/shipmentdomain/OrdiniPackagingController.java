...
public class OrdiniPackagingController implements Initializable {
    ...
    private void setup() {
        ...
        ordiniDiLavoroPackagingGrid.getTableColumns().addAll(dataCreazioneColumn, dataInizioPianificazioneColumn, dataInizioLavorazioneColumn, dataFineLavorazioneColumn, gruppoCorriereColumn, operatoreCorriereColumn, spedizioneColumn, statoColumn, noteAggiuntiveOperatoreColumn, noteAggiuntiveClienteColumn, magazzinoColumn, indirizzoSpedizioneColumn);
